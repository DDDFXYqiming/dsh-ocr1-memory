...
This path “automatically provides a small number of memory summaries”; it does not replace the complete `ocr1_mem_retrieve`. It is disabled by default because automatically injected content enters the model context and session records.
