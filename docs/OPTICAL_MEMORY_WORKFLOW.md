...
>
> 文档同时提供 Mermaid 图和纯文本图：如果 DSH 前端不渲染 Mermaid，可使用侧边栏预览插件查看 Mermaid 图，或直接阅读下面的 ASCII 版本。
...
└──────────────────────────────────────────────┘
                         │
                         ▼
              随年龄切换 vivid/normal/fuzzy
                         │
┌────────────────── 检索阶段 ──────────────────┐
│ Agent 查询                                    │
│       │                                       │
│       ▼                                       │
│ 光学定位器？ ──否──► 文本/OCR/Embedding 召回   │
│       │是                                     │
│       ▼                                       │
│ SoM 图像 ──► K 位 0/1 标签 ──► segment 编号   │
│                                      │        │
│                                      ▼        │
│                         memories.json 原文   │
│                                      │        │
