...
export function apply(ctx, config = {}) {
  const cfg = {
    ...
    opticalLocatorAutoStart: Boolean(config.opticalLocatorAutoStart),
    opticalLocatorServerPath: config.opticalLocatorServerPath || defaultOcrServerPath(),
    opticalLocatorModelDir: config.opticalLocatorModelDir || process.env.OPTICAL_LOCATOR_MODEL_DIR || '',
    opticalLocatorServerPort: Number(config.opticalLocatorServerPort ?? 18081),
    opticalLocatorModelFile: config.opticalLocatorModelFile || 'deepseek-ocr-locator-q8_0.gguf',
    opticalLocatorMmprojFile: config.opticalLocatorMmprojFile || 'mmproj-locator-q8_0.gguf',
