...
import { readMemoryContextSnapshot } from './context.js'
...
export const Config = Schema.object({
  ...
  autoInjectContext: Schema.boolean().default(false),
...
export function apply(ctx, config = {}) {
  const cfg = {
    ...
    autoInjectContext: Boolean(config.autoInjectContext),
